...
srvHitsForReceiverProject = function(projectID, batchID, hitID=0) {
    x = srvQuery(API=Motus$API_HITS_FOR_RECEIVER_PROJECT, params=list(projectID=projectID, batchID=batchID, hitID=hitID))
