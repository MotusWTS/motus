#' Get the hits blu data for a tag project
#'
...
srvHitsBluForTagProject <- function(projectID, batchID, hitID = 0, verbose = FALSE) {
  srvQuery(API = motus_vars$API_HITS_BLU_FOR_TAG_PROJECT, 
