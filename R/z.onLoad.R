  ...
  with(motus_vars,
       {
         ...
         API_HITS_BLU_BATCHES_FOR_TAG_PROJECT    <- "custom/hits_blu_batches_for_tag_project"
         API_HITS_BLU_BATCHES_FOR_RECEIVER       <- "custom/hits_blu_batches_for_receiver"
         API_HITS_BLU_FOR_TAG_PROJECT            <- "custom/hits_blu_for_tag_project"
         API_HITS_BLU_FOR_RECEIVER               <- "custom/hits_blu_for_receiver"
