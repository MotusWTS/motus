...
There are no missing start dates (`timeStart`), and deployment start dates range from `r min(year(df.tagDeps$timeStart))` to `r max(year(df.tagDeps$timeStart))`, which is reasonable for this project.  
