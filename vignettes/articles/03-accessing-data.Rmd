...
> **Advanced Topics:**  
>
> - `.motus` data base tables (*coming soon!*)
...
We recommend that when you transform your tables into flat dataframes, that you format the time stamp using the `lubridate` package at that time:
