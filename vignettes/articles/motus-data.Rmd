...
powered back up. A boot session is definied as the period between reboots.
...
- **New or modified tag deployment records**
  ...
  Similary, if a tag was mistakenly sought during a period when it was not
