...
Plot signal strength vs time for specified tag, faceted by site (ordered
by latitude) and coloured by antenna
...
- data:
  ...
  sig, ts, antBearing, recvDeployLat, fullID, recvDeployName, gpsLat,
  gpsLon
